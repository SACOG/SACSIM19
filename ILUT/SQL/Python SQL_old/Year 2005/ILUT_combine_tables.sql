...
--Zero values are dummy values to reflect lack of data for this column.
SELECT
	0 AS OBJECTID, --pm.OBJECTID,
	0 AS Join_Count, --pm.Join_Count,
	0 AS TARGET_FID, --pm.TARGET_FID,
	0 AS GISAc, --pm.GISAc,
	pcl.taz_p AS TAZ07, --pm.TAZ07,
	0 AS RAD07_NEW, --pm.RAD07_NEW,
	0 AS GEOID10NUM, --pm.GEOID10NUM,
	0 AS GUID2016, --pm.GUID2016,
	0 AS JURIS, --pm.JURIS,
	pcl.PARCELID,
	t.COUNTY AS County, --pm.County,
	0 AS ComType_BO, --pm.ComType_BO,
	0 AS TRACT10, --pm.TRACT10,
	0 AS BG_10, --pm.BG_10,
	0 AS plan_area, --pm.plan_area,
	0 AS TPA_16, --pm.TPA_16,
	0 AS TPA_40, --pm.TPA_40,
	0 AS DU_BO, --pm.DU_BO,
	0 AS EMP_BO, --pm.EMP_BO,
	0 AS EJ_2018, --pm.EJ_2018,
	0 AS TPA36_16, --pm.TPA36_16,
	0 AS PJOBC_NAME, --pm.PJOBC_NAME,
	0 AS PJOBC_4MI, --pm.PJOBC_4MI,
	0 AS PSJOBC_4MI, --pm.PSJOBC_4MI,
	0 AS HOMEEMP, --count of home-based jobs on parcel; only has data in base year. --eto.EMPHBB_SCNYR AS HOMEEMP, --count of home-based jobs on parcel; only has data in base year.
	0 AS DU_TOT, --dwelling units for scenario year; formatter brackets are the 2-digit year suffix. E.g., for 2016, this would be eto.du16 --eto.DU_SCNYR AS DU_TOT, --dwelling units for scenario year; formatter brackets are the 2-digit year suffix. E.g., for 2016, this would be eto.du16
	0 AS ResAcYr, --residential acres, TBD
	0 AS EmpAcYr, --employment acres, TBD
	0 AS LUTYPE, --eto.LU_SCNYR AS LUTYPE,--land use type for scen year
...
FROM {1} pcl --raw parcel scenario table
	LEFT JOIN TAZ07_RAD07 t --taz-rad lookup table
		ON pcl.taz_p = t.TAZ
	LEFT JOIN {2} hh --ilut hh table
		ON pcl.PARCELID = hh.parcelid
	LEFT JOIN {3} pp --ilut person table
		ON pcl.PARCELID = pp.parcelid
	LEFT JOIN {4} tt --ilut triptour table
		ON pcl.PARCELID = tt.parcelid
	LEFT JOIN {5} ixcv --ilut ixxicveh table
		ON pcl.PARCELID = ixcv.parcelid
