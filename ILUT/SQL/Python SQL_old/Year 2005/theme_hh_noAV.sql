...
--POP TABLE NOT AVAILABLE FOR 2005--replaced values with dummy variables
INSERT INTO #temp_hh
	SELECT DISTINCT
		hhparcel AS hhcel, --pop.hhcel,
		0 AS serialno, --pop.serialno,
		hh.hhincome,
		0 AS hh_hd_type, --CASE WHEN tp.hh_hd_type IS NULL THEN 0 ELSE tp.hh_hd_type END AS hh_hd_type, --
		hh.hrestype,
		hh.hhvehs
	FROM {1} hh --raw hh table
