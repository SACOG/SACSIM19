...
# adjusted script to agg residential and worker external VMT to hex
# Copyright:   (c) SACOG
# Python Version: 3.x
#--------------------------------
...
if __name__ == '__main__':
    ...
    tbl_ilutdata = "ILUT2016_50_wExWkrs_spring19"
    
    fc_hexoutput = "TAZ_ILUT{}{}".format(date_sufx, tbl_ilutdata)
    ...
    dict_fld_pcl_vals = {'POP_TOT':['POP', agg_sum],
                         ...
                         'VMT_WRK_RES': ['VMT_WRK_RES', agg_sum],
                         'VMT_wrk_tourend': ['VMT_wrk_tourend', agg_sum],
                         'JOB_ExWorker': ['JOB_ExWorker', agg_sum],
                         'exW_IX_VMT': ['exW_IX_VMT', agg_sum],
                         'VMT_wrk_wExWk': ['VMT_wrk_wExWk', agg_sum],
                         }
