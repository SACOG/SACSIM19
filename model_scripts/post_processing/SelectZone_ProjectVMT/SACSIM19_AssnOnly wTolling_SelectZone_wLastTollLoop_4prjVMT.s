...
;=======================================================
  ...
  ; add new temp file to simplify period outputs
   ...
   INCLUDE=A,B,DISTANCE,SPEED,NAME,CAPCLASS,CSPD_A,TOT_V_A,SVT_II_A,SVT_IX_A,SVT_XI_A,VT_XX_A,SVMTII_A,SVMTIX_A,SVMTXI_A,VMT_XX_A
    ...
    CSPD_Agrp=0
    if (CSPD_A=0.001-5.000) CSPD_Agrp=5
    if (CSPD_A=5.001-10.00) CSPD_Agrp=10
    if (CSPD_A=10.001-15.0) CSPD_Agrp=15
    if (CSPD_A=15.001-20.0) CSPD_Agrp=20
    if (CSPD_A=20.001-25.0) CSPD_Agrp=25
    if (CSPD_A=25.001-30.0) CSPD_Agrp=30
    if (CSPD_A=30.001-35.0) CSPD_Agrp=35
    if (CSPD_A=35.001-40.0) CSPD_Agrp=40
    if (CSPD_A=40.001-45.0) CSPD_Agrp=45
    if (CSPD_A=45.001-50.0) CSPD_Agrp=50
    if (CSPD_A=50.001-55.0) CSPD_Agrp=55
    if (CSPD_A=55.001-60.0) CSPD_Agrp=60
    if (CSPD_A=60.001-65.0) CSPD_Agrp=65
    if (CSPD_A=65.001-70.0) CSPD_Agrp=70
    if (CSPD_A=70.001-75.0) CSPD_Agrp=75
    if (CSPD_A=75.001-80.0) CSPD_Agrp=80
    if (CSPD_A=80.001-85.0) CSPD_Agrp=85
    if (CSPD_A >85.0) CSPD_Agrp=90
...
linko=?daynet_SZ_PjtVMT.dbf format=dbf
	...
	;split speeds into bins
	if (AM3CSPD_A=0.001-5.000) AM3CSPD_Agrp=5
	if (AM3CSPD_A=5.001-10.00) AM3CSPD_Agrp=10
	if (AM3CSPD_A=10.001-15.0) AM3CSPD_Agrp=15
	if (AM3CSPD_A=15.001-20.0) AM3CSPD_Agrp=20
	if (AM3CSPD_A=20.001-25.0) AM3CSPD_Agrp=25
	if (AM3CSPD_A=25.001-30.0) AM3CSPD_Agrp=30
	if (AM3CSPD_A=30.001-35.0) AM3CSPD_Agrp=35
	if (AM3CSPD_A=35.001-40.0) AM3CSPD_Agrp=40
	if (AM3CSPD_A=40.001-45.0) AM3CSPD_Agrp=45
	if (AM3CSPD_A=45.001-50.0) AM3CSPD_Agrp=50
	if (AM3CSPD_A=50.001-55.0) AM3CSPD_Agrp=55
	if (AM3CSPD_A=55.001-60.0) AM3CSPD_Agrp=60
	if (AM3CSPD_A=60.001-65.0) AM3CSPD_Agrp=65
	if (AM3CSPD_A=65.001-70.0) AM3CSPD_Agrp=70
	if (AM3CSPD_A=70.001-75.0) AM3CSPD_Agrp=75
	if (AM3CSPD_A=75.001-80.0) AM3CSPD_Agrp=80
	if (AM3CSPD_A=80.001-85.0) AM3CSPD_Agrp=85
	if (AM3CSPD_A >85.0) AM3CSPD_Agrp=90

	;split speeds into bins
	if (MD5CSPD_A=0.001-5.000) MD5CSPD_Agrp=5
	if (MD5CSPD_A=5.001-10.00) MD5CSPD_Agrp=10
	if (MD5CSPD_A=10.001-15.0) MD5CSPD_Agrp=15
	if (MD5CSPD_A=15.001-20.0) MD5CSPD_Agrp=20
	if (MD5CSPD_A=20.001-25.0) MD5CSPD_Agrp=25
	if (MD5CSPD_A=25.001-30.0) MD5CSPD_Agrp=30
	if (MD5CSPD_A=30.001-35.0) MD5CSPD_Agrp=35
	if (MD5CSPD_A=35.001-40.0) MD5CSPD_Agrp=40
	if (MD5CSPD_A=40.001-45.0) MD5CSPD_Agrp=45
	if (MD5CSPD_A=45.001-50.0) MD5CSPD_Agrp=50
	if (MD5CSPD_A=50.001-55.0) MD5CSPD_Agrp=55
	if (MD5CSPD_A=55.001-60.0) MD5CSPD_Agrp=60
	if (MD5CSPD_A=60.001-65.0) MD5CSPD_Agrp=65
	if (MD5CSPD_A=65.001-70.0) MD5CSPD_Agrp=70
	if (MD5CSPD_A=70.001-75.0) MD5CSPD_Agrp=75
	if (MD5CSPD_A=75.001-80.0) MD5CSPD_Agrp=80
	if (MD5CSPD_A=80.001-85.0) MD5CSPD_Agrp=85
	if (MD5CSPD_A >85.0) MD5CSPD_Agrp=90

	;split speeds into bins
	if (PM3CSPD_A=0.001-5.000) PM3CSPD_Agrp=5
	if (PM3CSPD_A=5.001-10.00) PM3CSPD_Agrp=10
	if (PM3CSPD_A=10.001-15.0) PM3CSPD_Agrp=15
	if (PM3CSPD_A=15.001-20.0) PM3CSPD_Agrp=20
	if (PM3CSPD_A=20.001-25.0) PM3CSPD_Agrp=25
	if (PM3CSPD_A=25.001-30.0) PM3CSPD_Agrp=30
	if (PM3CSPD_A=30.001-35.0) PM3CSPD_Agrp=35
	if (PM3CSPD_A=35.001-40.0) PM3CSPD_Agrp=40
	if (PM3CSPD_A=40.001-45.0) PM3CSPD_Agrp=45
	if (PM3CSPD_A=45.001-50.0) PM3CSPD_Agrp=50
	if (PM3CSPD_A=50.001-55.0) PM3CSPD_Agrp=55
	if (PM3CSPD_A=55.001-60.0) PM3CSPD_Agrp=60
	if (PM3CSPD_A=60.001-65.0) PM3CSPD_Agrp=65
	if (PM3CSPD_A=65.001-70.0) PM3CSPD_Agrp=70
	if (PM3CSPD_A=70.001-75.0) PM3CSPD_Agrp=75
	if (PM3CSPD_A=75.001-80.0) PM3CSPD_Agrp=80
	if (PM3CSPD_A=80.001-85.0) PM3CSPD_Agrp=85
	if (PM3CSPD_A >85.0) PM3CSPD_Agrp=90

	;split speeds into bins
	if (N13CSPD_A=0.001-5.000) N13CSPD_Agrp=5
	if (N13CSPD_A=5.001-10.00) N13CSPD_Agrp=10
	if (N13CSPD_A=10.001-15.0) N13CSPD_Agrp=15
	if (N13CSPD_A=15.001-20.0) N13CSPD_Agrp=20
	if (N13CSPD_A=20.001-25.0) N13CSPD_Agrp=25
	if (N13CSPD_A=25.001-30.0) N13CSPD_Agrp=30
	if (N13CSPD_A=30.001-35.0) N13CSPD_Agrp=35
	if (N13CSPD_A=35.001-40.0) N13CSPD_Agrp=40
	if (N13CSPD_A=40.001-45.0) N13CSPD_Agrp=45
	if (N13CSPD_A=45.001-50.0) N13CSPD_Agrp=50
	if (N13CSPD_A=50.001-55.0) N13CSPD_Agrp=55
	if (N13CSPD_A=55.001-60.0) N13CSPD_Agrp=60
	if (N13CSPD_A=60.001-65.0) N13CSPD_Agrp=65
	if (N13CSPD_A=65.001-70.0) N13CSPD_Agrp=70
	if (N13CSPD_A=70.001-75.0) N13CSPD_Agrp=75
	if (N13CSPD_A=75.001-80.0) N13CSPD_Agrp=80
	if (N13CSPD_A=80.001-85.0) N13CSPD_Agrp=85
	if (N13CSPD_A >85.0) N13CSPD_Agrp=90

	;split speeds into bins
	if (DYCSPD_A=0.001-5.000) DYCSPD_Agrp=5
	if (DYCSPD_A=5.001-10.00) DYCSPD_Agrp=10
	if (DYCSPD_A=10.001-15.0) DYCSPD_Agrp=15
	if (DYCSPD_A=15.001-20.0) DYCSPD_Agrp=20
	if (DYCSPD_A=20.001-25.0) DYCSPD_Agrp=25
	if (DYCSPD_A=25.001-30.0) DYCSPD_Agrp=30
	if (DYCSPD_A=30.001-35.0) DYCSPD_Agrp=35
	if (DYCSPD_A=35.001-40.0) DYCSPD_Agrp=40
	if (DYCSPD_A=40.001-45.0) DYCSPD_Agrp=45
	if (DYCSPD_A=45.001-50.0) DYCSPD_Agrp=50
	if (DYCSPD_A=50.001-55.0) DYCSPD_Agrp=55
	if (DYCSPD_A=55.001-60.0) DYCSPD_Agrp=60
	if (DYCSPD_A=60.001-65.0) DYCSPD_Agrp=65
	if (DYCSPD_A=65.001-70.0) DYCSPD_Agrp=70
	if (DYCSPD_A=70.001-75.0) DYCSPD_Agrp=75
	if (DYCSPD_A=75.001-80.0) DYCSPD_Agrp=80
	if (DYCSPD_A=80.001-85.0) DYCSPD_Agrp=85
	if (DYCSPD_A >85.0) DYCSPD_Agrp=90
