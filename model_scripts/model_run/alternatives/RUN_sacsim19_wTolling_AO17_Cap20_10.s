...
endrun
   ...
   *echo Begin converting trips Iter @iter.i@>timelog.beginconverttrips.iter@iter.i@.txt
    ...
    *echo Begin airport model Iter @iter.i@>timelog.beginairport.iter@iter.i@.txt
    ...
    ;CostPerMile = AutoCostPerMile*100
    VehPerPers = 0.57
    ...
    *echo Begin highway assignments Iter @iter.i@>timelog.beginhwyassign.iter@iter.i@.txt
	...
	_maxTollChange = 0
	change_thresh = 0.50 ; If toll doesnt change by more than this amount stop iterating
	...
	loop toop = 1,5    ;toll_loop = toop
      ...
      endrun
		...
		;------ Note:  Freeway 20% increase, 10% on others
		  SPDCAP CAPACITY[1]=2400,1100,935,880,770,1650,0,2400,1800				
		  SPDCAP CAPACITY[11]=0,1800,0,0,0,2400,0,0,0				
		  SPDCAP CAPACITY[21]=0,1100,0,825,0,550,0,0,0				
		  SPDCAP CAPACITY[51]=2400,0,0,0,0,1800,0,0,0				
		  SPDCAP CAPACITY[62]=0,0                                                  ;special classes:  62=pnr dummy link; 63=centroid conn
          SPDCAP CAPACITY[99]=0
