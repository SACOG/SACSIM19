...
def make_tables(create_triptour_table = False,
    ...
    sc_yr = 2016 #input("Enter scenario year: ")
    ...
    pop_table = 'raw_Pop2016_latest'#input("Copy/paste population table name: ")
...
if __name__ == '__main__':
    ...
    while True:
        envision_tomorrow_tbl = 'raw_eto2016_latest'#input("Enter future parcel/ETO table name: ")
